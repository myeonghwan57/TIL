...
```python
d1 = Director.objects.get(name = '봉준호')
print('id :',d1.id)
print('name :',d1.name)
...
for i in range(1,10):
    ...
    print(movie.director,movie.genre,
...
```python
d = Director.objects.get(name = '봉준호')
movie = Movie.objects.filter(director_id = d.id).order_by('opening_date')[1]
...
movie = Movie.objects.filter(opening_date__gte=day).order_by('opening_date')
for i in movie:
    d = Director.objects.get(id = i.director_id )
    t = Genre.objects.get(id = i.genre_id) 
    print(d.name,t.title,
...
```python
d = Director.objects.get(name = '봉준호')
t = Genre.objects.get(title = '드라마') 
movie=Movie.objects.filter(director_id = d.id,genre_id = t.id).order_by('opening_date')
for i in movie:
    print(d.name,t.title,
    i.title,i.opening_date,
    i.running_time,i.screening)
...
```python
d = Director.objects.get(name = '봉준호')
movie=Movie.objects.exclude( director_id = d.id).order_by('opening_date')
for i in movie:
    d1 = Director.objects.get(id = i.director_id )
    t = Genre.objects.get(id = i.genre_id) 
    print(d1.name,t.title,
    i.title,i.opening_date,
    i.running_time,i.screening)
